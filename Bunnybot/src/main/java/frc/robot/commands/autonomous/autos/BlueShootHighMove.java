...
public class BlueShootHighMove extends AutoCommand {
    public BlueShootHighMove(Launcher launcher, Indexer indexer, Intake intake){
        super(
            ...
            .andThen(new FollowPathCommand(getChoreoTrajectory("BlueMoveOut"), Suppliers.isRedAlliance, ""))
