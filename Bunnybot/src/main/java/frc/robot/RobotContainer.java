...
public class RobotContainer {
    ...
    private final Trigger INTAKE_DEPLOY = operatorController.rightTrigger();
    private final Trigger INTAKE_STOW = operatorController.rightBumper();
    private final Trigger INTAKE = operatorController.leftBumper();
    ...
    private void configureBindings() {
        ...
        LAUNCH.whileTrue(new DeferredCommand(
                () -> launcher.setLauncherCommand(SmartDashboard.getNumber("bottom_launcher_motor", 0.4),
                        SmartDashboard.getNumber("top_launcher_motor", 0.4)),
                Set.of(launcher))).onFalse(launcher.stopLauncherCommand());
