...
import frc.robot.subsystems.swerve.BBConstants; 

public class CTRESwerveWrapper {
    private double MaxSpeed = (BBConstants.kSpeedAt12Volts).in(MetersPerSecond); // kSpeedAt12Volts desired top speed
    ...
    private final SwerveDrivetrain<TalonFX, TalonFX, CANcoder> drivetrain = BBConstants.createDrivetrain();
